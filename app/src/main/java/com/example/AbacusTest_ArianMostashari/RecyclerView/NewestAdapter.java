...
public class NewestAdapter extends RecyclerView.Adapter<NewestAdapter.ViewHolder> {
  ...
  public NewestAdapter(ArrayList<CardModel> cardModels, Context context) {
  ...
  @Override
  public void onBindViewHolder(@NonNull NewestAdapter.ViewHolder viewHolder, int position) {
