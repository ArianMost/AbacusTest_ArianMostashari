...
public class TopRatedAdapter extends RecyclerView.Adapter<TopRatedAdapter.ViewHolder> {
  ...
  public TopRatedAdapter(ArrayList<CardModel> cardModels, Context context) {
  ...
  @Override
  public void onBindViewHolder(@NonNull TopRatedAdapter.ViewHolder viewHolder, int position) {
